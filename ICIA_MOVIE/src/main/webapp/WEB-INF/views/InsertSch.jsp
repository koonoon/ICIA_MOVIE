					...
					<div class="logo-area">
						<div class="row align-items-center">
							<div
								...
								<a class="d-block" href="index.html"> <img loading="lazy"
							...
							<div class="col-lg-9 header-right">
								<ul class="top-info-box">
										...
										<div class="info-box">
											<div class="info-box-content">
												...
												<p class="info-box-subtitle">
													<a href="tel:(+9) 847-291-4353">(+9) 847-291-4353</a>
												</p>
											</div>
										</div>
									</li>
									<li>
										<div class="info-box">
											<div class="info-box-content">
												...
												<p class="info-box-subtitle">
													<a href="mailto:office@Constra.com">office@Constra.com</a>
												</p>
											</div>
										</div>
									</li>
									...
									<li class="header-get-a-quote"><a class="btn btn-primary"
										href="contact.html">Get A Quote</a></li>
								</ul>
								<!-- Ul end -->
							</div>
							<!-- header right end -->
							...
							<nav class="navbar navbar-expand-lg navbar-dark p-0">
								...
								<div id="navbar-collapse" class="collapse navbar-collapse">
									<ul class="nav navbar-nav mr-auto">
										...
										<li class="nav-item"><a class="nav-link" href="movies">상영
												목록</a></li>
									...
									<nav class="navbar navbar-expand-lg navbar-light p-0 ">
										...
										<ul class="nav navbar-nav mr-auto ">
											...
											<li class="nav-item dropdown" ><a href="#"
												class="nav-link dropdown-toggle" data-toggle="dropdown">영화관코드
													<i class="fa fa-angle-down" style="color: #ff0000"
													onclick ="location.href ='thList'"></i>
											</a>
												<ul class="dropdown-menu" role="menu" >
															...
															<div>
																<div class="radio-check">
																	...
																	<input type="radio" id="open" name="thCode"
																		...
																		class="form-radio-label">${tl.thCode}</label>
																</div>
															</div>
														</c:forEach></li>
								...
								<div class="col-md-12">
									<nav class="navbar navbar-expand-lg navbar-light p-0 ">
										...
										<ul class="nav navbar-nav mr-auto">
											...
											<li class="nav-item dropdown"><a href="#"
												class="nav-link dropdown-toggle" data-toggle="dropdown">영화
													코드 <i class="fa fa-angle-down" style="color: #ff0000"
													onclick ="location.href ='thList2'"></i>
											</a>
												<ul class="dropdown-menu" role="menu">
