...
<body>
	<div class="body-inner">
		...
		<div id="banner-area" class="banner-area"
			style="background-image: url(resources/images/banner/banner1.jpg)">
			<div class="banner-text">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="banner-heading">
								<h1 class="banner-title">영화관 목록</h1>
						...
						<div class="sidebar sidebar-left">
							<div class="widget">
								...
								<ul class="nav service-menu">
									<li class="active"><a href="#">영화관 목록</a></li>
									<li><a href="#">영화관 목록</a></li>
							...
							<div class="widget">
								<div class="quote-item quote-border">
									<div class="quote-text-border">Anim pariatur cliche
							...
							<div class="container">
								<div class="row">
									...
									<div class="comments-form border-box">
										<h3 class="title-normal">영화관 목록</h3>
										<div class="card">
											<div class="card-body">
												<h5 class="card-title">전체 영화관</h5>
					...
					<div class="row justify-content-between">
						<div class="col-lg-4 col-md-6 footer-widget footer-about">
							...
							<img loading="lazy" width="200px" class="footer-logo"
								src="images/footer-logo.png" alt="Constra">
